                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <form action="ControladorProducto" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Nombre del producto" name="txtNombreProducto" required>
                            ...
                            <textarea class="form-control" rows="3" name = "txtDescripcion" placeholder="Descripción del producto" required></textarea>
                            <label for="precio">Precio</label>
                            <input type="number" class="form-control" placeholder="Precio unitario" name="txtPrecio" step="0.01" min = "0" required>
