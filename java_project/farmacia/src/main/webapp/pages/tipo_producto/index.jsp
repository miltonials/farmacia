        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <a class="btn btn-primary" href="ControladorTipoProducto?accion=agregar" method="GET">Agregar Tipo de producto</a>
                    <div class="table-responsive">
                        <table class="table table-striped table-sm">
                            ...
                            <c:forEach items="${farmacia.getTiposProductos()}" var="tipo" >
                                <tr>
                                    <td>${tipo.getId()}</td>
