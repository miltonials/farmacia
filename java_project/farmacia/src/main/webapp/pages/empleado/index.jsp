        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <a class="btn btn-primary" href="ControladorEmpleado?accion=agregar" method="GET">Agregar Empleado</a>
                    <div class="table-responsive">
                        <table class="table table-striped table-sm">
                            ...
                            <c:forEach var="emp" items="${farmacia.getEmpleados()}">
                                <tr>
                                    <td>${emp.getId()}</td>
                                    ...
                                    <td>${emp.getFechaContratacion()}</td>
                                    <td>${emp.getClave()}</td>
                                    <td>
