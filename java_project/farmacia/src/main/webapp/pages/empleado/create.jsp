                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <form action="ControladorEmpleado" method="POST">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="Salario" name="txtSalario" step="0.01" min = "0" required>
                            
                            <label for="fecha">Fecha de contratación</label>
                            <input type="date" class="form-control" name="txtFechaContratacion" min="2023-03-01" max="2024-03-01"required>
                            
                            <label for="clave">Clave</label>
                            <input type="text" class="form-control" placeholder="Clave" name="txtClave" required>
